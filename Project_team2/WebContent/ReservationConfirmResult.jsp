...
<head>
<meta charset="UTF-8">
<title>ReservationConfirmResult(이름,전화번호로 예약 확인하기)</title>
<style type="text/css">
...
<body>
	<%
		...
		List reservationList = rdao.listReservation(reservationVO);
...
<jsp:include page="include/userHeader.jsp" />
	<div class="content" align="center">
		...
		<table width="1150" border="1">
			...
			<tr height="150">
				<td align="center" colspan="10">만약 예약하신
					정보가 나오지 않았다면,<br> 이름과 전화번호를 다시 확인하시고 입력해 주세요.<br> <br>
					<br>
					<input type="button" value="확인" onclick="location.href='ReservationForm.jsp'">
				</td>
			</tr>
		</table>
	</div>
